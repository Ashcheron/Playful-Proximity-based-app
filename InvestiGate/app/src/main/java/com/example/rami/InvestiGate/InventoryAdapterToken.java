 ...
 */
public class InventoryAdapterToken extends android.widget.ArrayAdapter {
     ...
     */
    public InventoryAdapterToken(Context context, ArrayList<Token> values, int category) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Context needs to be cast as Activity to be able move between activities in adapter
